...
export default class Menu {
    ...
    constructor(game) {
        ...
        window.addEventListener('keydown', (event) => {
            if (this.game.input.inputBlocked) return;
        ...
        this.sensitivitySlider = this.createSlider(this.game.input.sensitivity * 5000);
        this.sensitivitySlider.addEventListener('input', (event) => {
            this.game.input.sensitivity = event.target.value / 5000;
            this.sensitivityText.innerText = 'Mouse Sensitivity: ' + this.game.input.sensitivity;
        });
