...
import * as Weapon from '../player/weapons/index';
...
export default class Player extends THREE.Object3D {
     ...
     * @param {*} netData 
     */
    constructor(scene, { x = 0, y = 1, z = 0 }, isRemote = false, camera, id = null, netData = null) {
        super();
        this.scene = scene;
        this.camera = camera;
    ...
    createBody() {
        ...
        Globals.physicsWorld.addBody(this.body);
        this.body.id = 'player';
